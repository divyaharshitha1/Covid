...
class Charts extends Component {
  ...
  graphCharts = () => (
    <div>
      ...
      <div /* testid="lineChartsContainer" */ className="lineCharts-graph">
      ...
      <>
        {isLoading ? (
          ...
          <div className="charts-container">
            <div className="charts-BarChart-desktop">
              <BarChart
                width={700}
                height={240}
                barSize={35}
            ...
            <div className="charts-BarChart-mobile">
              <BarChart
                width={450}
                height={200}
                barSize={25}
            ...
            <div className="charts-bar-graph">{this.graphCharts()}</div>
          </div>
        )}
      </>
    )
